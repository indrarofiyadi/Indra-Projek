...
<html>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a href="user data.php">Data Pengguna</a></li>
			<li><a href="registration.php">Registrasi</a></li>
			<li><a class="active" href="read tag.php">Daftar ID/Pengguna</a></li>
		</ul>
		
		<br>
		
		<h3 align="center" id="blink">Silakan Pindai Tag untuk Menampilkan ID atau Data Pengguna</h3>
					...
					<tr>
						<td  bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr>
									<td align="left" class="lf">No.Hp</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
							</table>
